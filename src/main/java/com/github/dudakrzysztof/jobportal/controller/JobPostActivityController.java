package com.github.dudakrzysztof.jobportal.controller;

import com.github.dudakrzysztof.jobportal.entity.*;
import com.github.dudakrzysztof.jobportal.services.JobPostActivityService;
import com.github.dudakrzysztof.jobportal.services.JobSeekerApplyService;
import com.github.dudakrzysztof.jobportal.services.JobSeekerSaveService;
import com.github.dudakrzysztof.jobportal.services.UsersService;
    ...
    public String searchJobs(Model model,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                List<RecruiterJobDto> recruiterJobs = jobPostActivityService
